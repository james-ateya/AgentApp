...
public class PermissionUtils
{
    ...
    private  boolean checkAndRequestPermissions(ArrayList<String> permissions, int request_code) {
        ...
        if(permissions.size()>0)
        {
            ...
            {
                int hasPermission = checkSelfPermission(current_activity,permissions.get(i));
            ...
            {
                androidx.core.app.ActivityCompat.requestPermissions(current_activity, listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]),request_code);
                return false;
            }
        }
            ...
            case 1:
                if(grantResults.length>0)
                {
                    ...
                    for (int i = 0; i < listPermissionsNeeded.size(); i++)
                    {
                        ...
                        {
                            if(androidx.core.app.ActivityCompat.shouldShowRequestPermissionRationale(current_activity,listPermissionsNeeded.get(i)))
